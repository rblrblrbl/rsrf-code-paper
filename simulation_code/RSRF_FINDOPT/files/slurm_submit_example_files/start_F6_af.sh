...
#SBATCH --job-name=af_fo_F6
#SBATCH --mail-type=ALL
#SBATCH --output=rsrf_af_fo_F6.%j.txt
...
R CMD BATCH --no-save --no-restore --slave '--args F 6 rsrf_af FALSE 209' findopt_rsrf_doparallel_server_slurm.R
...
rsync -av $RESULTDIR ~/RSRF_findopt/F6/results_af
